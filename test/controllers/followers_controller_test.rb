...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post followers_url, params: { follower: { follower_id: @follower.follower_id, following_id: @follower.following_id, user_id: @follower.user_id } }
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { follower_id: @follower.follower_id, following_id: @follower.following_id, user_id: @follower.user_id } }
